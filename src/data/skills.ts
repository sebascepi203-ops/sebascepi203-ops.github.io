export const skills = [
  {
    ...
    title: "Redes",
    description: "Tengo conocimientos relacionados a redes, como seria la configuracion de dispositivos, asignación de dirección IP, tecnología de fibra optica, entre otros.",
  },
  {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 17l-5-5 5-5v3l-2 2 2 2v3zm8-10l5 5-5 5v-3l2-2-2-2V7z"/></svg>`,
    title: "Ciberseguridad",
    description: "Tengo conocimiento de la ISO 27000, en la cual se detalla temas relacionados a la ciberseguridad.",
  },
  {
    ...
    description: "Poseo habilidades para el aspecto de Desarrollo web. Se incluye conocimientos de html, CSS, Javascripts y el uso de Frameworks.",
  },
  {
